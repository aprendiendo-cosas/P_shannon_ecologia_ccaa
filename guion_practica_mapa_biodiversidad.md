...
+ Instrumentales:
  ...
  + Conocer el lenguaje de programación R e iniciarnos en su manejo.
...
La ejecución del anterior flujo de trabajo se realiza usando R. R es un lenguaje de programación muy frecuentemente utilizado en ámbitos científicos. Se usa para hacer análisis de datos, dibujar gráficas, mapas, etc. En esta práctica nos familiarizaremos un poco con este lenguaje. Concretamente usaremos un interfaz gráfico llamado RStudio. Este vídeo describe de forma rápida y fácil en qué consisten tanto R como Rstudio. 
